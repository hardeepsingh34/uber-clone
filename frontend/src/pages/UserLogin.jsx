  ...
  return (
    <div>
        <div className=' h-screen flex flex-col  justify-between p-5'>
           ...
           <h3 className='text-sm'>New here? <Link to="/signup" className='text-blue-500'>Create New Account</Link></h3>
           </div>
        </div>
        <Link to="/captain/login" className='bg-emerald-400 py-2 flex justify-center rounded-sm mb-7 text-white'>Sign in as Captain</Link>
            </div>
    </div>
  )
}
