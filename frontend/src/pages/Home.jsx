...
const Home = () => {
  return (
    <div className='bg-red-400 h-screen flex flex-col items-center justify-start '>
        <div style={{ backgroundImage: `url(${trafficLight})` }} className='bg-cover  h-[80%] w-full flex p-4 '>
        ...
        <div className="h-34 bg-white w-screen p-4 ">
            ...
            <Link to="/login" className='bg-black text-white p-3 px-32 m-3 my-6'>Continue</Link>
        </div>
    </div>
  )
}
